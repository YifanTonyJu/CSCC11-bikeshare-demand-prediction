...
Bike-sharing systems are an important component of urban transportation, providing a flexible solution for short-distance travel. Accurate bike demand prediction is essential for efficient resource allocation, such as bike rebalancing and station management.
...
We construct a regression pipeline based on feature engineering, including temporal, station-specific, user behavior, and lag-based features, to capture both short-term and long-term demand patterns.
...
% TODO (group): list models (e.g., Ridge Regression, Random Forest, XGBoost)
% TODO (group): mention evaluation metrics (e.g., MAE, RMSE)
